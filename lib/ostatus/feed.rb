...
require_relative 'utils/feed_link_discoverer'
  ...
  class Feed < Atom::Feed
    ...
    def initialize(str, url, access_token, options)
      ...
      if str
        ...
        if str =~ /<html/
          relative_url = OStatus::Utils::FeedLinkDiscoverer.new(str).feed_link_url

          # Resolve relative links
          link = URI::parse(relative_url) rescue URI.new
